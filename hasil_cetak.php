...
arsort($bayes['hasil']);
?>
<p>Hasil Terbesar Didapatkan oleh Penyakit = <strong><?= $penyakit[key($bayes['hasil'])]->nama_penyakit ?></strong>
    <!-- dengan Nilai = <strong><?= round(current($bayes['hasil']), 4) ?></strong></p> -->
<p>
